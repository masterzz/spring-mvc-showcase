package org.springframework.ioc.enjoy.cap11.config;
...
@Configuration
@ComponentScan("org.springframework.ioc.enjoy.cap11")
...
public class Cap11MainConfig {
	...
	public DataSource dataSource() throws PropertyVetoException{
		...
		dataSource.setUser("health_check");
		dataSource.setPassword("health_check@123");
		dataSource.setDriverClass("com.mysql.jdbc.Driver");
		dataSource.setJdbcUrl("jdbc:mysql://132.97.189.127:3306/wo_app");
		return dataSource;
	}
